...
export class MyComponent {
  ...
  {
    title: 'Why RxJS Remains Essential in Angular, Even with Signals',
    phase: 'Looking Forward',
    goal: 'Understanding the continued importance of RxJS in modern Angular development',
    content: [
      'Asynchronous Operations: HttpClient returns Observables for API requests, Router.events provides streams of navigation events',
      'Reactive Forms: valueChanges and statusChanges are Observables for form inputs and validation',
      'User Interaction: For complex event patterns like drag-and-drop, real-time drawing, or multiple DOM events',
      'Transformation & Filtering: Over 100 operators for data manipulation (map, filter, reduce, scan, distinctUntilChanged, etc.)',
      'Concurrency Control: switchMap, mergeMap, concatMap, and exhaustMap manage the order and cancellation of async operations',
      'Combination: combineLatest, forkJoin, zip, withLatestFrom combine data from multiple independent sources',
      'Error Handling & Retries: catchError and retry/retryWhen for robust error management',
      'State Management: Libraries like NgRx leverage RxJS for actions, effects, and selectors',
      'Push-Based Reactivity: RxJS "pushes" new values to subscribers, while Signals are "pull-based"',
      'Interoperability: toSignal() and toObservable() allow both paradigms to work together seamlessly',
    ],
  },
  {
